...
EXEC = progTri
OBJETS = util.o tri.o tas.o fusion.o
NOM_PROJET = 501_tp1
...
tri.o: tri.c tri.h tas.h types.h util.h
tas.o: tas.c tas.h types.h
fusion.o: fusion.c fusion.h types.h
progTri.o: progTri.c util.h types.h tri.h tas.h
